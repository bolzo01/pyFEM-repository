...
Last modified: 2025/11/17 22:07:28
...
from .materials import LinearElastic1D, Material
...
class PostProcessor:
    ...
    def _resolve_material(self, elem_prop, label: str) -> Material:
        """Retrieve the Material object associated with an element."""
        ...
        if material_name is None:
            ...
            if isinstance(raw, str):
                ...
                raise ValueError(
                    f"Element property '{label}' has invalid material name: {raw!r}"
                )
