...
ELEMENT_PROBLEM_COMPATIBILITY: dict[str, set[tuple[Physics, Dimension]]] = {
    # Mechanics elements
    "spring_1D": {(Physics.MECHANICS, Dimension.D1)},
    "bar_1D": {(Physics.MECHANICS, Dimension.D1)},
    "bar3_1D": {(Physics.MECHANICS, Dimension.D1)},
    "bar_2D": {(Physics.MECHANICS, Dimension.D2)},
    "triangle": {(Physics.MECHANICS, Dimension.D2)},
