...
The use of functions is demonstrated throughout the script.
...
def apply_nodal_forces(applied_forces, global_force_vector):
    """
...
def invert_global_stiffness_matrix(global_stiffness_matrix):
    """
