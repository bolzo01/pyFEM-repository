...
Last modified: 2025/11/27 12:52:47
    ...
    def _execute_static_linear_incremental(self, model, model_state, use_sparse=True):
        ...
        for i in range(1, self.increments + 1):
            ...
            if self.control == "displacement":
                ...
                solver.apply_boundary_conditions(load_factor=1.0)  # do NOT scale forces
            else:
                solver.apply_boundary_conditions(load_factor=lam)  # scale forces only
