...
applied_forces = [
    [
        0,
        10.0,
    ],  # DOF 1 has an applied force of 10      # vector = [DOF_index, forza_valore]
]
...
for _ in range(
    total_dofs
):  # _ indica che non serve il valore dell’indice (non ci interessa contare, ci basta ripetere).
    global_stiffness_matrix.append(
        [0.0] * total_dofs
    )  # append() è un metodo delle liste di Python che aggiunge un singolo elemento in fondo alla lista.
